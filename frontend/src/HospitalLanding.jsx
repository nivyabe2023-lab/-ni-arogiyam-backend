...
import exactBuildingImg from "./assets/exact_building_right.png";
  ...
  return (
    <div className="exact-page-root">
      ...
      <div className="exact-top-bar">
        <div className="exact-top-bar-inner">
          <div className="top-left-location">
            <svg className="pin-svg" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="top-right-meta">
            <span className="emergency-text">24/7 Emergency Care</span>
            <a href="tel:+914523503500" className="phone-anchor">
              <svg className="phone-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="social-icons-tray">
              <a href="#facebook" aria-label="Facebook" className="social-anchor">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#instagram" aria-label="Instagram" className="social-anchor">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="#youtube" aria-label="YouTube" className="social-anchor">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              <a href="#linkedin" aria-label="LinkedIn" className="social-anchor">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* =======================================================
          2. MAIN NAVBAR
          ======================================================= */}
      <header className="exact-main-nav">
        <div className="exact-nav-inner">
          {/* LOGO */}
          <div className="brand-logo-unit" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
            <div className="logo-svg-holder">
              <svg viewBox="0 0 48 48" fill="none" className="stethoscope-svg-element">
            ...
            <div className="brand-text-holder">
              <span className="brand-title-text">NI AROGIYAM</span>
              <span className="brand-subtitle-text">— INTELLIGENT HEALTHCARE SYSTEM —</span>
            </div>
          </div>

          {/* NAV LINKS */}
          <nav className="nav-links-menu">
            <div className="nav-item-wrap active-item-wrap">
              <a href="#home" className="nav-link-btn active-link-btn">Home</a>
              <div className="active-pill-bar"></div>
            </div>

            <div className="nav-item-wrap">
              <a href="#about" className="nav-link-btn">About Us</a>
            </div>

            <div
              className="nav-item-wrap dropdown-hover-wrap"
              onMouseEnter={() => setSpecialtiesDropdown(true)}
              onMouseLeave={() => setSpecialtiesDropdown(false)}
            >
              <a href="#specialties" className="nav-link-btn">
                Specialties <span className="arrow-down">⌄</span>
              </a>
              {specialtiesDropdown && (
            ...
            <div className="nav-item-wrap">
              <a href="#facilities" className="nav-link-btn">Facilities</a>
            </div>
            ...
            >
              <a href="#patients-visitors" className="nav-link-btn">
                Patients &amp; Visitors <span className="arrow-down">⌄</span>
              </a>
              {visitorDropdown && (
                <div className="dropdown-flyout-menu">
            ...
            <div className="nav-item-wrap">
              <a href="#doctors" className="nav-link-btn">Our Doctors</a>
            </div>
          ...
          <div className="nav-action-button-wrap">
            <button
              type="button"
              className="btn-book-appointment-solid"
      ...
      {/* =======================================================
          3. HERO SECTION (USING EXACT EXTRACTED BUILDING IMAGE)
          ======================================================= */}
      <section id="home" className="exact-hero-stage">
        <div className="hero-stage-inner">
          {/* LEFT: TEXT CONTENT */}
          <div className="hero-left-text-box">
            <h1 className="hero-main-title">
              <span className="text-line-dark">Advanced Medicine.</span>
              <span className="text-line-green">Compassionate Healing.</span>
              <span className="text-line-dark">World-Class Care.</span>
            </h1>
            ...
            <div className="hero-stats-row-4">
              {/* Stat 1: Bed Capacity */}
              <div className="circle-stat-card">
                ...
                <strong className="stat-num-value">500+</strong>
                <span className="stat-sub-label">Bed Capacity</span>
              </div>
              ...
              <div className="circle-stat-card">
                ...
                <strong className="stat-num-value">40+</strong>
                <span className="stat-sub-label">Specialties</span>
              </div>
              ...
              <div className="circle-stat-card">
                ...
                <strong className="stat-num-value">1L+</strong>
                <span className="stat-sub-label">Patients Treated</span>
              </div>
              ...
              <div className="circle-stat-card">
                ...
                <strong className="stat-num-value">4th Gen</strong>
                <span className="stat-sub-label">Robotic Surgery</span>
              </div>
            </div>
          </div>

          {/* RIGHT: EXACT CRISP HOSPITAL BUILDING IMAGE */}
          <div className="hero-right-image-box">
            <img
              src={exactBuildingImg}
              alt="NI AROGIYAM Hospital Grand Building"
              className="exact-hospital-image-render"
            />
          </div>
        </div>
      </section>
      ...
      {/* =======================================================
          ...
          ======================================================= */}
      <section className="dark-emerald-ribbon">
        <div className="ribbon-items-wrapper">
          {/* 1. 24/7 Emergency Care */}
          <div className="ribbon-column-item">
            ...
            <div className="ribbon-text-block">
              <h3 className="ribbon-item-title">24/7</h3>
              <p className="ribbon-item-caption">Emergency Care</p>
            </div>
          </div>

          <div className="ribbon-vertical-divider"></div>
          ...
          <div className="ribbon-column-item">
            ...
            <div className="ribbon-text-block">
              <h3 className="ribbon-item-title">Cashless</h3>
              <p className="ribbon-item-caption">Insurance</p>
            </div>
          </div>
          ...
          <div className="ribbon-column-item">
            ...
            <div className="ribbon-text-block">
              <h3 className="ribbon-item-title">40+</h3>
              <p className="ribbon-item-caption">TPA Partners</p>
            </div>
          </div>
          ...
          <div className="ribbon-column-item">
            ...
            <div className="ribbon-text-block">
              <h3 className="ribbon-item-title">Advanced</h3>
              <p className="ribbon-item-caption">Technology</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* =======================================================
          ...
          ======================================================= */}
      <section id="specialties" className="exact-specialties-strip">
        <h2 className="specialties-section-heading">Our Specialties</h2>

        <div className="specialties-cards-container-7">
          {/* 1. Cardiology */}
          <div className="specialty-card-box" onClick={() => handleSpecialtyClick("Cardiology")}>
            <div className="specialty-svg-box">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="#0d9488">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg>
            </div>
            <span className="specialty-title-label">Cardiology</span>
          </div>

          {/* 2. Neurology */}
          <div className="specialty-card-box" onClick={() => handleSpecialtyClick("Neurology")}>
            <div className="specialty-svg-box">
            ...
            <span className="specialty-title-label">Neurology</span>
          </div>

          {/* 3. Oncology */}
          <div className="specialty-card-box" onClick={() => handleSpecialtyClick("Oncology")}>
            <div className="specialty-svg-box">
            ...
            <span className="specialty-title-label">Oncology</span>
          </div>

          {/* 4. Orthopedics */}
          <div className="specialty-card-box" onClick={() => handleSpecialtyClick("Orthopedics")}>
            <div className="specialty-svg-box">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="specialty-title-label">Orthopedics</span>
          </div>

          {/* 5. Gastroenterology */}
          <div className="specialty-card-box" onClick={() => handleSpecialtyClick("Gastroenterology")}>
            <div className="specialty-svg-box">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18 3a3 3 0 0 0-3 3v2a3 3 0 0 1-3 3H9a5 5 0 0 0-5 5v1a5 5 0 0 0 5 5h3a6 6 0 0 0 6-6V6a3 3 0 0 0-3-3z"></path>
              </svg>
            </div>
            <span className="specialty-title-label">Gastroenterology</span>
          </div>

          {/* 6. Nephrology */}
          <div className="specialty-card-box" onClick={() => handleSpecialtyClick("Nephrology")}>
            <div className="specialty-svg-box">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="specialty-title-label">Nephrology</span>
          </div>

          {/* 7. View All */}
          <div className="specialty-card-box view-all-card-box" onClick={() => handleSpecialtyClick("View All")}>
            <div className="specialty-svg-box">
            ...
            <span className="specialty-title-label text-deep-green">View All</span>
          </div>
        </div>
      </section>
      ...
      {/* =======================================================
          ...
          ======================================================= */}
      <section className="why-choose-header-strip">
        <h2 className="why-choose-main-heading">
          Why Choose <span className="green-accent-word">NI AROGIYAM?</span>
        </h2>
      </section>
      ...
      {/* =======================================================
          ...
          ======================================================= */}
      {bookingModalOpen && (
        <div className="exact-modal-overlay" onClick={() => setBookingModalOpen(false)}>
          <div className="exact-modal-card" onClick={(e) => e.stopPropagation()}>
            <div className="exact-modal-top">
              <div>
            ...
            {bookingSuccess ? (
              <div className="modal-success-screen">
                <div className="green-circle-tick">✓</div>
                ...
                <p className="sms-confirmation-text">
                  📱 Confirmation SMS sent to <strong>{appointmentForm.phoneNumber}</strong>.
                </p>
              </div>
            ) : (
              <form onSubmit={handleBookingSubmit} className="exact-modal-form">
