...
export default function HospitalLanding() {
  ...
  return (
    <div className="exact-hospital-page">
      {/* =======================================================
          1. TOP CONTACT & SOCIAL BAR (EXACT MATCH)
          ======================================================= */}
      ...
      <header className="exact-header">
        <div className="exact-header-inner">
          ...
          <nav className="header-nav-menu">
            ...
            >
              <a href="#specialties" className="menu-link has-dropdown">
                Specialties <span className="dropdown-caret">⌄</span>
              </a>
              {specialtiesDropdown && (
            ...
            >
              <a href="#patients-visitors" className="menu-link has-dropdown">
                Patients &amp; Visitors <span className="dropdown-caret">⌄</span>
              </a>
              {visitorDropdown && (
                <div className="dropdown-popover">
                  ...
                  <a href="#facilities" onClick={() => setVisitorDropdown(false)}>Cashless Insurance Desk</a>
                </div>
              )}
            </div>
        ...
        <div className="exact-hero-container">
          <div className="hero-content-column">
            <h1 className="hero-main-heading">
              <span className="heading-line-1">Advanced Medicine.</span>
              <span className="heading-line-2">Compassionate Healing.</span>
              <span className="heading-line-3">World-Class Care.</span>
            </h1>
      ...
      {/* =======================================================
          4. DARK GREEN FEATURE RIBBON (EXACT MATCH)
          ======================================================= */}
      ...
      <section id="specialties" className="exact-specialties-section">
        ...
        <div className="specialties-row-7">
          ...
          <div className="specialty-card view-all-card" onClick={() => handleSpecialtyClick("View All")}>
            ...
            <span className="specialty-name">View All</span>
          </div>
        </div>
      </section>

      {/* =======================================================
          6. WHY CHOOSE SECTION HEADER (EXACT MATCH)
          ======================================================= */}
      <section className="exact-why-choose-header-only">
